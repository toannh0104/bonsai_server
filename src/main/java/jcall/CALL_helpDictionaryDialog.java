...
public class CALL_helpDictionaryDialog extends JDialog implements ActionListener {
  ...
  public CALL_helpDictionaryDialog(CALL_main p) {
    ...
    java.net.URL notesURL = CALL_titlePanel.class.getResource("../Data/html/diagramHelp.html");
    if (notesURL != null) {
      try {
      ...
      // CALL_debug.printlog(CALL_debug.MOD_GENERAL, CALL_debug.ERROR,
      // "Couldn't find file: ../Data/html/diagramHelp.html");
    }
