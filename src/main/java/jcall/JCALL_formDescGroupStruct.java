...
public class JCALL_formDescGroupStruct {
  // Fields
  ...
  public JCALL_formDescGroupStruct() {
    forms = new Vector();
  ...
  public CALL_stringPairsStruct getFormText(JCALL_questionStruct struct) {
    CALL_formDescStruct form;
              ...
              if (valueString != null) {
                if (parmString.startsWith("[")) {
                  ...
                  if (struct.instance != null) {
                    parmString = struct.instance.getDataString(parmString);
                    if (parmString != null) {
                  ...
                  if (parmString.equals("question")) {
                    if (operatorString.equals("==")) {
                      if (!valueString.equals(struct.lessonQuestion.question)) {
                        match = false;
                      }
                    } else if (operatorString.equals("!=")) {
                      if (valueString.equals(struct.lessonQuestion.question)) {
                    ...
                    if (operatorString.equals("==")) {
                      if (!valueString.equals(struct.lessonConcept.concept)) {
                        match = false;
                      }
                    } else if (operatorString.equals("!=")) {
                      if (valueString.equals(struct.lessonConcept.concept)) {
                    ...
                    if (operatorString.equals("==")) {
                      if (!valueString.equals(struct.diagram.name)) {
                        match = false;
                      }
                    } else if (operatorString.equals("!=")) {
                      if (valueString.equals(struct.diagram.name)) {
                    ...
                    if (operatorString.equals("==")) {
                      if (valueString.equals("positive")) {
                        if (struct.sentence.sign != CALL_formStruct.POSITIVE) {
                          match = false;
                        }
                      }
                      if (valueString.equals("negative")) {
                        if (struct.sentence.sign != CALL_formStruct.NEGATIVE) {
                          match = false;
                        }
                      }
                    } else if (operatorString.equals("!=")) {
                    ...
                    if (operatorString.equals("==")) {
                      if (valueString.equals("past")) {
                        if (struct.sentence.tense != CALL_formStruct.PAST) {
                          match = false;
                        }
                      }
                      if (valueString.equals("present")) {
                        if (struct.sentence.tense != CALL_formStruct.PRESENT) {
                          match = false;
                        }
                      }
                    } else if (operatorString.equals("!=")) {
                    ...
                    if (operatorString.equals("==")) {
                      if (valueString.equals("polite")) {
                        if (struct.sentence.style != CALL_formStruct.POLITE) {
                          match = false;
                        }
                      }
                      if (valueString.equals("plain")) {
                        if (struct.sentence.style != CALL_formStruct.PLAIN) {
                          match = false;
                        }
                      }
                      if (valueString.equals("superpolite")) {
                        if (struct.sentence.style != CALL_formStruct.SUPER_POLITE) {
                          match = false;
                        }
                      }
                      if (valueString.equals("crude")) {
                        if (struct.sentence.style != CALL_formStruct.CRUDE) {
                          match = false;
                        }
                      }
                    } else if (operatorString.equals("!=")) {
                    ...
                    if (operatorString.equals("==")) {
                      if (valueString.equals("question")) {
                        if (struct.sentence.type != CALL_formStruct.QUESTION) {
                          match = false;
                        }
                      }
                      if (valueString.equals("statement")) {
                        if (struct.sentence.type != CALL_formStruct.STATEMENT) {
                          match = false;
                        }
                      }
                    } else if (operatorString.equals("!=")) {
