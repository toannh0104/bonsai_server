...
public class JCALL_sentenceHintsStruct {
  ...
  // Empty Constructor
  public JCALL_sentenceHintsStruct() {
    // Does nothing
    costCoefficient = 1.0;
  ...
  public JCALL_sentenceHintsStruct(JCALL_questionStruct question) {
    costCoefficient = 1.0;
    wordHints = new Vector();
    levelStrings = new Vector();
    generate(question);
            ...
            if (sentenceWord != null) {
              ...
              if (word != null) {
                ...
                if (wordHint != null) {
                  ...
                  // Surface form (don't worry about postfix / prefix here -
                  // CJW)
                  // ==================================================================================
                  if (question.config.hintLevelSurface) {
