...
public class JCALL_SWComponent extends JCALL_WordBase {

  static Logger logger = Logger.getLogger(JCALL_SWComponent.class.getName());
  JCALL_WordBase prefix;
  JCALL_WordBase suffix;// what if two or more suffixes

  // Vector<JCALL_WSubs> vSubsWord;

  public JCALL_SWComponent() {
    // TODO Auto-generated constructor stub
    super();
    // prefix = null;
    // suffix = null;
    String perfix;
    String suffix; // can contain two or more suffixes; like "san;kun"
    // vSubsWord = null;
  }

  public JCALL_SWComponent(int id, int intType, String strKana, String strKanji) {
    super(id, intType, strKana, strKanji);
    // TODO Auto-generated constructor stub
  }

  public JCALL_SWComponent(int intType, String strKana, String strKanji) {
