...
public class JCALL_SWComponentNew extends JCALL_WordBase {

  static Logger logger = Logger.getLogger(JCALL_SWComponentNew.class.getName());
  JCALL_WordBase prefix;
  JCALL_WordBase suffix;// what if two or more suffixes

  // Vector<JCALL_WSubs> vSubsWord;

  public JCALL_SWComponentNew() {
  ...
  public JCALL_SWComponentNew(int id, int intType, String strKana, String strKanji) {
    super(id, intType, strKana, strKanji);
    // TODO Auto-generated constructor stub
  }

  public JCALL_SWComponentNew(int intType, String strKana, String strKanji) {
