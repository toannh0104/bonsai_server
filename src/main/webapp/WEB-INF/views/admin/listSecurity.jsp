...
<div class="listLesson">
	<a href="${pageContext.request.contextPath}/admin/newSecurity?lang=EN">Create new Lesson Security</a>
	<form:form modelAttribute="lessonForm" id="lessonForm">
		...
		<table>
			...
			<c:forEach items="${lstLessonDto}" var="lessonDto" varStatus="status">
				<tr>
					<td><a href="#" onclick="adminSecurity(${lessonDto.id });">${lessonDto.lessonName }</a></td>
